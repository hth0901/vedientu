                    ...
                    <div className="row">
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4">
                                <a href="index.html" className="ftco-heading-2">
                ...
                <div className="footer-bottom">
                    <div className="row">
                        <div className="col-md-9">
                            <p>
                                Bản quyền Website thuộc về Trung tâm Bảo tồn Di
                                tích Cố đô Huế
                                <br />
                                Địa chỉ: Tam Toà, 23 Tống Duy Tân - thành phố
                                Huế, Việt Nam
                                <br />
                        ...
                        <div className="col-md-3 text-right">
                            ...
                            <div className="copyright-pane">
                                ...
                                <div className="copyright">
                                    ...
                                    <a target="_blank" href="www.huecit.vn">
                                        HueCIT
                                    </a>
                                </div>
                            </div>
